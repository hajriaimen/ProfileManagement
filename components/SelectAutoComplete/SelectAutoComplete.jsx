...
class SelectAutoComplete extends React.Component {
  ...
  handleChangeSelect(value) {
    ...
    const {
      handleChange, setFieldValue, setFieldTouched, name, fieldAarrayName,
      fieldAarrayIndex,
    } = this.props;
    ...
    handleChange(`${fieldAarrayName}[${fieldAarrayIndex}].${name}`);
    setFieldTouched(`${fieldAarrayName}[${fieldAarrayIndex}].${name}`, true);
    setFieldValue(`${fieldAarrayName}[${fieldAarrayIndex}].${name}`, value, false);
    return true;
  }
    ...
    return (
      <div>
        <FormControl
          fullWidth
          error={
            getLoDash(touched, `${fieldAarrayName}[${fieldAarrayIndex}].${name}`, false)
            && !!getLoDash(errors, `${fieldAarrayName}[${fieldAarrayIndex}].${name}`, false)
          }
        >
          <Select
            classes={classes}
